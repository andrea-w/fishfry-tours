...
def render_graphiql_page() -> str:
    ...
    graphiql_html_file = "{}/static/graphiql.html".format(dir_path)
...
class GraphQLView(View):
    ...
    async def dispatch_request(self, *args: Any, **kwargs: Any) -> Union[ResponseReturnValue, str]:
        ...
        result = await self.schema.execute(request_data.query, variable_values=request_data.variables, context_value=context, operation_name=request_data.operation_name, root_value=None)
